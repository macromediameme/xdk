/*
	$Workfile: mixagent.h $
	$Archive: /Xtras/Include/mixagent.h $
	$Author: Greggy $
	$Date: 4/10/00 2:02 PM $
	$Revision: 5 $
...
typedef MoaFileType FAR *			PMoaFileType;
typedef const MoaFileType FAR * 	ConstPMoaFileType;
typedef MoaLong 					MoaScrapType;
typedef MoaScrapType FAR *			PMoaScrapType;
typedef const MoaScrapType FAR *	ConstPMoaScrapType;
...
typedef IMoaReceptor FAR * PIMoaReceptor;
...
typedef IMoaReceptorText FAR * PIMoaReceptorText;
...
typedef IMoaReceptorUnicode FAR * PIMoaReceptorUnicode;
...
typedef MixAnchorBounds FAR * PMixAnchorBounds;
typedef const MixAnchorBounds FAR * ConstPMixAnchorBounds;
...
typedef IMoaReceptorAnchor FAR * PIMoaReceptorAnchor;
...
typedef IMoaReceptorDataObject FAR * PIMoaReceptorDataObject;
...
typedef IMoaAgent FAR * PIMoaAgent;
...
*/
{
	...
	MoaDeclareMethod(CountUnderstoodReceptorIDs, (THIS_
		moa_out MoaLong FAR * pNumReceptors
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetNthUnderstoodReceptorID, (THIS_
		...
		moa_out MoaInterfaceID FAR * ppReceptorIID
	))
/*	Description
...
*/
	MoaDeclareMethod(GetReaderOptions, (THIS_
		moa_out PIMoaDict FAR * ppOptionsDict
	))
...
*/
	...
	MoaDeclareMethod(CountUserSelectors, (THIS_
		moa_out MoaLong FAR * pNumSelectors
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetNthUserSelector, (THIS_
		...
		moa_out PIMoaDict FAR * ppSelectorData
	))
/*	Description
...
typedef IMoaReader FAR * PIMoaReader;
...
typedef IMoaStreamReader FAR *PIMoaStreamReader;
...
typedef IMoaWriter FAR * PIMoaWriter;
...
typedef IMoaLegger FAR * PIMoaLegger;
...
typedef IMoaLegger2 FAR * PIMoaLegger2;
