/*
	$Workfile: MIXPIX.H $
	$Archive: /Xtras/Include/MIXPIX.H $
	$Author: Greggy $
	$Date: 6/23/99 11:54 AM $
	$Revision: 2 $
	...
	Abstract:
 	...
 	Revision history:
	960521	First distribution with the rest of MIX. Altered the 
			RenderPixelColorSpace structure to pad it to 32 bits.
			Altered the IID of the interface (everyone must recompile)!
			Cleaned up some comments and formatting. Changed all
			/ / comments to / * * / (the former aren't ANSI C, alas...) (srj)
*/
...
typedef MoaPixelFormat FAR * PMoaPixelFormat;
typedef const MoaPixelFormat FAR * ConstPMoaPixelFormat;
...
typedef IMoaReceptorPixels FAR * PIMoaReceptorPixels;
