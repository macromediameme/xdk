...
/* ================================================================================
	...
	07apr98	LLB	Use MoaBoolParam. Added ValidateListExistence.
	15dec97	LLB	Added structure packing pragmas
	22oct97	LLB	Added CountElements and mListIP members.
	07jcw97	jcw	Added RemoveValue and RemoveAllValues to MmListHelper.
				Added MoaLinearListHelper with accessors for symbols, strings, and values.
	24apr97 alx	Added descriptions
	24mar97 jcw	Added minimize layout style (GetMinimize, SetMinimize)
	18mar97	alx	Include name changes
	08mar97	jcw	new header file format, documentation for external consumption.
	05feb97	alx	Yanked stuff from MMValue/PropHelp
