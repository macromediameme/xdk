/*
	$Workfile: MIXSVC.H $
	$Archive: /Xtras/Include/MIXSVC.H $
	$Author: Greggy $
	$Date: 11/23/99 1:50p $
	$Revision: 4 $

	Copyright (c) 1994, 1995, 1996, 1997-1999 Macromedia, Inc.	All Rights Reserved
	...
	Revision history:
	23nov99	greggy	Never present hidden MIX readers.
	951018	Original. (srj)
*/
...
typedef MoaLeggerInfoSignature FAR * PMoaLeggerInfoSignature;
typedef const MoaLeggerInfoSignature FAR * ConstPMoaLeggerInfoSignature;
...
*/
	...
	MoaDeclareMethod(CreateLegger, (THIS_
		moa_out PIMoaLegger FAR * ppLegger
	))
...
*/
	...
	MoaDeclareMethod(GetLeggerType, (THIS_
		moa_out MoaLong FAR * pLeggerType
	))
/*	Description
...
typedef IMoaLeggerInfo FAR * PIMoaLeggerInfo;
...
*/
{
	...
	MoaDeclareMethod(Next, (THIS_
		...
		moa_out PIMoaLeggerInfo FAR * pLI,
...
*/
	...
	MoaDeclareMethod(Clone, (THIS_
		moa_out struct IMoaEnumLeggerInfo FAR * FAR * ppEnum
	))
...
typedef IMoaEnumLeggerInfo FAR * PIMoaEnumLeggerInfo;
...
*/
	...
	MoaDeclareMethod(EnumLeggersForData, (THIS_
		...
		moa_out PIMoaEnumLeggerInfo FAR * ppEnum
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(ReCreateLeggerInfo, (THIS_
		...
		moa_out PIMoaLeggerInfo FAR * ppLeggerInfo
	))
/*	Description
...
typedef IMoaLegServices FAR * PIMoaLegServices;
...
*/
{
	...
	MoaDeclareMethod(GetBestFileTypes, (THIS_
		moa_out MoaFileType FAR * pFileType,
		moa_out MoaFileType FAR * pFileCreator
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetBestScrapType, (THIS_
		moa_out MoaScrapType FAR * pType
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetFileTypes, (THIS_
		...
		moa_out MoaLong FAR * pNumTypes,
		moa_out MoaFileType FAR * pTypes
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetScrapTypes, (THIS_
		moa_in MoaLong maxNumTypes,
		moa_out MoaLong FAR * pNumTypes,
		moa_out MoaScrapType FAR * pTypes
	))
/*	Description
...
typedef IMoaMixFormatInfo FAR * PIMoaMixFormatInfo;
...
*/
	...
	MoaDeclareMethod(GetFormatInfo, (THIS_
		moa_in MoaLong numFormats,
		moa_in ConstPMixFormat pFormats,
		moa_out PIMoaMixFormatInfo FAR * ppInfo
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(FindFormatsForFile, (THIS_
		...
		moa_out MoaLong FAR * pNumFormats,
...
typedef IMoaFormatServices FAR * PIMoaFormatServices;
...
*/
	...
	MoaDeclareMethod(CreateReader, (THIS_
		...
		moa_out PIMoaReader FAR * ppReader
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(CreateWriter, (THIS_
		...
		moa_out PIMoaWriter FAR * ppWriter
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(GetAgentRegInfo, (THIS_
		moa_out PIMoaRegistryEntryDict FAR * ppRegDict,
		moa_out MoaClassID FAR * pClassID
	))
/*	Description
...
typedef IMoaMixAgentInfo FAR * PIMoaMixAgentInfo;
...
*/
{
	...
	MoaDeclareMethod(Next, (THIS_
		moa_in MoaUlong celt,
		moa_out PIMoaMixAgentInfo FAR * ppAgentInfo,
		moa_out MoaUlong FAR * pCeltFetched
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(Clone, (THIS_
		moa_out struct IMoaEnumMixAgentInfo FAR * FAR * ppEnum
	))
/*	Description
...
typedef IMoaEnumMixAgentInfo FAR * PIMoaEnumMixAgentInfo;
...
*/
{
	...
	MoaDeclareMethod(GetWriterInfo, (THIS_
		...
		moa_out PIMoaEnumMixAgentInfo FAR * ppEnum
	))
/*	Description
...
typedef IMoaAgentServices FAR * PIMoaAgentServices;
...
*/
{
	...
	MoaDeclareMethod(CreateEmptyDataObject, (THIS_
		moa_out PIMoaDataObject FAR * ppData
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(AddReadersToDataObject, (THIS_
		...
		moa_in PIMoaReader FAR * pReaderArray,
...
*/
	...
	MoaDeclareMethod(DataObjectToMoaStream, (THIS_
		...
		moa_out PIMoaStream FAR * ppStream
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(ExpandDraggedFiles, (THIS_
		moa_in PIMoaDataObject pDataIn,
		moa_out PIMoaDataObject FAR * ppDataOut
	))
/*	Description
...
typedef IMoaDataObjectServices FAR * PIMoaDataObjectServices;
DEFINE_GUID(IID_IMoaDataObjectServices, 0x2253DDA6L, 0xCA88, 0x11CF, 0xAD, 0x29, 0x08, 0x00, 0x07, 0x16, 0x0D, 0xC3);

/* -------------------------------------------------------------------------- */

typedef struct _MoaDragRegRef FAR * MoaDragRegRef;
...
*/
{
	...
	MoaDeclareMethod(RegisterDrag, (THIS_
		...
		moa_out MoaDragRegRef FAR * pRegisterRef
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(DoDrag, (THIS_
		...
		moa_out MoaLong FAR * pEffectUsed
	))
/*	Description
...
typedef IMoaDragServices FAR * PIMoaDragServices;
...
*/
	...
	MoaDeclareMethod(CalcFlatDictSize, (THIS_
		...
		moa_out MoaLong FAR * pFlatDictLen
	))
/*	Description
...
typedef IMoaDictServices FAR * PIMoaDictServices;
...
typedef IMoaTempStreamServices FAR * PIMoaTempStreamServices;
...
typedef IMoaMixMiscServices FAR * PIMoaMixMiscServices;
...
typedef MoaPipeServerID FAR * PMoaPipeServerID;
typedef const MoaPipeServerID FAR * ConstPMoaPipeServerID;
typedef struct _MoaLeggerPipeRef FAR * MoaLeggerPipeRef;
...
*/
{
	...
	MoaDeclareMethod(CreateLeggerPipe, (THIS_
		...
		moa_out PIMoaLegger FAR * ppLegPipe
	))
/*	Description
...
*/
	...
	MoaDeclareMethod(InstallLeggerPipe, (THIS_
		...
		moa_out MoaLeggerPipeRef FAR * pRef
	))
/*	Description
...
typedef IMoaLeggerPipeServices FAR * PIMoaLeggerPipeServices;
...
typedef IMoaMacServices FAR * PIMoaMacServices;
...
#undef INTERFACE
	...
	#define MakeGetSvc(svc) \
		inline MoaError Get##svc(PIMoaCallback pCbk, P##svc FAR * ppSvc) \
