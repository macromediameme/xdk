...
/* =========================================================================
	...
	Copyright (c) 1994 - 1998 Macromedia, Inc.  All Rights Reserved
	...
	18spe98	JT	Updated Comments
	15jul98	JT D7 Beta 1 preparation.
	26jun98 JT Created.
...
DECLARE_INTERFACE_(IMoaMmPropertyReference, IMoaUnknown)
{
	...
	/ !!@ Reserved for future use. Director 7 does not make these calls.
	*/
...
typedef IMoaMmPropertyReference FAR * PIMoaMmPropertyReference;
...
typedef IMoaMmPropReferenceValue FAR * PIMoaMmPropReferenceValue;
