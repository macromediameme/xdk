...
/* ================================================================================
	...
	27jul99	alx	Added VisRgnHelper -- not used yet!
	24sep98	LLB	Added CMoaMmGCSaver, MacToMoaModifiers, MoaToMacModifiers and MacGetModifierState.
	13nov97	LLB	Added SetClipAndRestore and SetOriginAndRestore.
	27oct97	alx	Added GWorldHelper
	16jul97	alx	Fixed FontHelper unsigned/signed problem
	18mar97	alx	Rename includes
	08mar97	jcw	new header file format, documentation for external consumption.
	19dec96	jcw Added GetFontBaseline
	19dec96	alx Added MouseMoved
	11dec96	alx Added default PenNormal to PensizeHelper
	02dec96	alx Added GetDialogBaseUnit to FontHelper
	26nov96	alx	Broken out from MuiHelpr.h
...
#else
			mOldFont = aPort->txFont;
			mOldFace = aPort->txFace;
			mOldSize = aPort->txSize;
			mOldMode = aPort->txMode;
#endif
...
class CMoaMmGCSaver
{
	public:
					   ...
					   ConstPMoaPoint pMoaOrigin)
		{
			...
			mpPortSaver	  = new SetPortAndRestore	((GrafPtr)(pNativeGC)->data.mac_window.windowPtr);
