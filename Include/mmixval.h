...
/* =========================================================================
	...
	Copyright (c) 2000 Macromedia, Inc.  All Rights Reserved
	...
	20feb00 CN d8.5  First checked in version
...
} MoaMmValueDescription, FAR *PMoaMmValueDescription;
...
typedef IMoaMmXValue FAR * PIMoaMmXValue;
...
typedef IMoaMmXValueUtils FAR * PIMoaMmXValueUtils;
