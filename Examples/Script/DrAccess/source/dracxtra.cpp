 ...
 ****************************************************************************/ 
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CDrAccessRegister, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CDrAccessRegister, IMoaRegister, XTRA_VERSION_NUMBER) 
	END_XTRA_DEFINES_CLASS

	BEGIN_XTRA_DEFINES_CLASS(CDrAccessScript, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CDrAccessScript, IMoaMmXScript, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CDrAccessScript, IMoaInitFromDict, XTRA_VERSION_NUMBER)	
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CDrAccessScript, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
	END_XTRA_DEFINES_CLASS
END_XTRA
