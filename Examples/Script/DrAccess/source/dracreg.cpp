...
STDMETHODIMP MoaCreate_CDrAccessRegister(CDrAccessRegister FAR * This)
{
	UNUSED(This);
...
STDMETHODIMP_(void) MoaDestroy_CDrAccessRegister(CDrAccessRegister FAR * This)
{
	UNUSED(This);
...
CDrAccessRegister_IMoaRegister::CDrAccessRegister_IMoaRegister(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
