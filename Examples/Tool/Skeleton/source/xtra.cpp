 ...
 *	Name: xtra.cpp
 *	
 * 	Purpose: The Xtra definition of a tool Xtra.
 *
 ...
 *****************************************************************************/ 
 BEGIN_XTRA
	...
	END_XTRA_DEFINES_CLASS
 	BEGIN_XTRA_DEFINES_CLASS(CTool, XTRA_VERSION_NUMBER)
 		CLASS_DEFINES_INTERFACE(CTool, IMoaMmXTool, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
 		CLASS_DEFINES_INTERFACE(CTool, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CTool, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
 		/*
		 * ---> insert additional interface(s) -->
		 */ 
