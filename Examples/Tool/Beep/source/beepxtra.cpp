 ...
 *****************************************************************************/ 
 BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CBeepReg, XTRA_VERSION_NUMBER)
 		CLASS_DEFINES_INTERFACE(CBeepReg, IMoaRegister, XTRA_VERSION_NUMBER)
	END_XTRA_DEFINES_CLASS
 	BEGIN_XTRA_DEFINES_CLASS(CBeepTool, XTRA_VERSION_NUMBER)
 		CLASS_DEFINES_INTERFACE(CBeepTool, IMoaMmXTool, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
 		CLASS_DEFINES_INTERFACE(CBeepTool, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CBeepTool, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
	END_XTRA_DEFINES_CLASS
END_XTRA
