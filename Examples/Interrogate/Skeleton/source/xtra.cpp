 ...
 *	Name: xtra.cpp
 *	
 * 	Purpose: The Xtra definition of a genberic Interrogator Xtra.
 *
...
BEGIN_XTRA
	...
	BEGIN_XTRA_DEFINES_CLASS(CInterrogator, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CInterrogator, IMoaMmInterrogator, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CInterrogator, IMoaMmTerminator, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CInterrogator, IMoaInitFromDict, XTRA_VERSION_NUMBER)	
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CInterrogator, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
		/*
		 * ---> insert additional interface(s) -->
		 */ 
