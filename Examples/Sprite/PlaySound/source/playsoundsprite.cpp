...
STDMETHODIMP MoaCreate_CPlaySoundSprite(CPlaySoundSprite FAR * This)
{
moa_try
	This->pStrm = NULL;	
	This->cid = 0;
...
STDMETHODIMP_(void) MoaDestroy_CPlaySoundSprite(CPlaySoundSprite FAR * This)
{	
...
CPlaySoundSprite_IMoaMmXSpriteActor::CPlaySoundSprite_IMoaMmXSpriteActor(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
STDMETHODIMP CPlaySoundSprite_IMoaMmXSpriteActor::ContainsPoint(ConstPMoaMmXSpriteInfo pActorInfo, ConstPMoaPoint pTestPoint, MoaBoolParam FAR * pTestResult)
{
	MoaError	err = kMoaErr_NoErr;
...
STDMETHODIMP CPlaySoundSprite_IMoaMmXSpriteActor::Event(ConstPMoaMmEventInfo pEventInfo,	ConstPMoaMmPlayerStateInfo	pPlayerStateInfo, MoaBoolParam FAR *	pHandled)
{
moa_try
