 ...
 ****************************************************************************/ 
BEGIN_DEFINE_CLASS_INTERFACE(CPlaySoundRegister, IMoaRegister) 
...
/* ---------------------------------------------------- MoaCreate_CRegister */
STDMETHODIMP MoaCreate_CPlaySoundRegister(CPlaySoundRegister FAR * This)
{
	UNUSED(This);
...
STDMETHODIMP_(void) MoaDestroy_CPlaySoundRegister(CPlaySoundRegister FAR * This)
{
	UNUSED(This);
...
CPlaySoundRegister_IMoaRegister::CPlaySoundRegister_IMoaRegister(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
CPlaySoundRegister_IMoaRegister::~CPlaySoundRegister_IMoaRegister() {}
...
STDMETHODIMP_(MoaError) CPlaySoundRegister_IMoaRegister::Register(PIMoaCache pCache,
    PIMoaDict pXtraDict)
{
	...
	char* 				symStr[kMyAssetTypeCount] 		= {"PlaySound"};
	char* 				nameStr[kMyAssetTypeCount] 		= {"PlaySound Xtra"};
