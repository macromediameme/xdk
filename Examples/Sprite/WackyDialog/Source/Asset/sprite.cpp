...
STDMETHODIMP MoaCreate_CWackyDlgSprite( CWackyDlgSprite FAR * This )
{
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CWackyDlgSprite( CWackyDlgSprite FAR * This )
{
	X_ENTER
...
STDMETHODIMP CWackyDlgSprite_IMoaMmXSpriteActor::Notify( MoaLong msgCode, PMoaVoid refCon )
{
	...
	switch( msgCode )
	{
		case kSprNotifyMsg_SetParentAsset:
			pObj->mAsset = (CWackyDlgAsset_IMoaMmXAsset FAR *)refCon;
			pObj->mAsset->AddRef();
			break;
...
STDMETHODIMP CWackyDlgSprite_IMoaMmXSpriteActor::Event( ConstPMoaMmEventInfo /*pEventInfo*/, ConstPMoaMmPlayerStateInfo /*pPlayerStateInfo*/, MoaBoolParam FAR * /*pHandled*/ )
{
	X_ENTER
	X_STD_RETURN( kMoaErr_NoErr );
	X_EXIT
