...
///////////////////////////////////////////////////////////////////////////////
 ...
 BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CMoaPropsDialog, XTRA_CLASS_VERSION)
 		CLASS_DEFINES_INTERFACE(CMoaPropsDialog, IMoaPropsDialog, XTRA_VERSION_NUMBER)
...
STDMETHODIMP MoaCreate_CMoaPropsDialog( CMoaPropsDialog FAR * This )
{
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CMoaPropsDialog( CMoaPropsDialog FAR * /*This*/ )
{
	X_ENTER
...
MoaError CMoaPropsDialog_IMoaPropsDialog::InvokePropsDialog( PMoaVoid asset, PIMoaDrAssetCallback pDrCallback, PIMoaMmAssetCallback pMmCallback )
{
	...
	WackyPropsDialog propsDialog( (CWackyDlgAsset_IMoaMmXAsset FAR *)asset, pDrCallback, pMmCallback );
...
WackyPropsDialog::WackyPropsDialog( CWackyDlgAsset_IMoaMmXAsset FAR * pAsset, PIMoaDrAssetCallback pDrCallback, PIMoaMmAssetCallback pMmCallback ) :
	mUsePreview( false ),
	mHideStuff( false ),
