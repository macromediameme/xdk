 ...
 *	Name: ITXtra.cpp
 *	
 * 	Purpose: The Xtra definition of the InkTest Sprite Xtra example.
 *
 ****************************************************************************/ 
 ...
 ****************************************************************************/ 
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CInkTestRegister, XTRA_VERSION_NUMBER) 
		CLASS_DEFINES_INTERFACE(CInkTestRegister, IMoaRegister, XTRA_VERSION_NUMBER)
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CInkTestAsset, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CInkTestAsset, IMoaMmXAsset, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CInkTestAsset, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CInkTestSprite, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CInkTestSprite, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CInkTestSprite, IMoaMmXSpriteActor, XTRA_VERSION_NUMBER)
	END_XTRA_DEFINES_CLASS
END_XTRA
