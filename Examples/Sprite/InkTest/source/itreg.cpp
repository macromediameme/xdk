...
/* ---------------------------------------------------- MoaCreate_CRegister */
STDMETHODIMP MoaCreate_CInkTestRegister(CInkTestRegister FAR * This)
{
	UNUSED(This);
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CInkTestRegister(CInkTestRegister FAR * This)
{
	UNUSED(This);
	X_ENTER
...
CInkTestRegister_IMoaRegister::CInkTestRegister_IMoaRegister(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
