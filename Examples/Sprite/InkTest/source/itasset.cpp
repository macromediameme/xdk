...
STDMETHODIMP  		MoaCreate_CInkTestAsset(CInkTestAsset FAR * This)
{
	UNUSED(This);
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CInkTestAsset(CInkTestAsset FAR * This)
{
	UNUSED(This);
	X_ENTER
...
CInkTestAsset_IMoaMmXAsset::CInkTestAsset_IMoaMmXAsset(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
CInkTestAsset_IMoaMmXAsset::~CInkTestAsset_IMoaMmXAsset() {}

#ifdef USING_INIT_FROM_DICT
/* ------------------------------------ CInkTestAsset_IMoaInitFromDict Create/Destroy */
CInkTestAsset_IMoaInitFromDict::CInkTestAsset_IMoaInitFromDict(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
CInkTestAsset_IMoaNotificationClient::CInkTestAsset_IMoaNotificationClient(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
MoaError CInkTestAsset::ImageCreate(PImageData pImage) {
	...
	if (hPic) 
	{
		...
		oserr = NewGWorld(&pGWorld, 8, &bounds, NULL, NULL, 0);
		if (oserr == noErr) 
		{
			CGrafPtr savePort;
			GDHandle saveDev;
		...
		if ( (pCallback->QueryInterface(&IID_IMoaMmUtils, &pUtils)) == kMoaErr_NoErr) 
		{
...
STDMETHODIMP CInkTestAsset_IMoaMmXAsset::GetInMemMediaSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CInkTestAsset_IMoaMmXAsset::GetStreamOutMediaSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CInkTestAsset_IMoaMmXAsset::GetInMemPropsSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CInkTestAsset_IMoaMmXAsset::GetStreamOutPropsSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CInkTestAsset_IMoaMmXAsset::NewXActor(PMoaVoid FAR * ppXActor) 
{
	X_ENTER
