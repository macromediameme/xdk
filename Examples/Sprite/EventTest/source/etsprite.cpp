...
STDMETHODIMP MoaCreate_CEventTestSprite(CEventTestSprite FAR * This)
{
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CEventTestSprite(CEventTestSprite FAR * This)
{
	X_ENTER
...
CEventTestSprite_IMoaMmXSpriteActor::CEventTestSprite_IMoaMmXSpriteActor(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
STDMETHODIMP CEventTestSprite_IMoaMmXSpriteActor::ContainsPoint(ConstPMoaMmXSpriteInfo pActorInfo, ConstPMoaPoint pTestPoint, MoaBoolParam FAR * pTestResult)
{
	X_ENTER
...
STDMETHODIMP CEventTestSprite_IMoaMmXSpriteActor::Event(ConstPMoaMmEventInfo pEventInfo,	ConstPMoaMmPlayerStateInfo	pPlayerStateInfo, MoaBoolParam FAR *	pHandled)
{
	X_ENTER
