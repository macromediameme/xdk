 ...
 *           class interface(s) for EventTest Xtra's Register class.
 *
 **********************************************************************************/ 
 ...
 *	a valid CLSID.
 ****************************************************************************/ 
DEFINE_GUID(CLSID(CEventTestRegister), 0x732B8A14L, 0x97EA, 0x11D0, 0x95, 0x0C, 0x00, 0x05, 0x02, 0x70, 0xB2, 0x08);
 ...
 *****************************************************************************/ 
EXTERN_BEGIN_DEFINE_CLASS_INSTANCE_VARS(CEventTestRegister) 
	MoaLong	instData;
 ...
 ****************************************************************************/ 
EXTERN_BEGIN_DEFINE_CLASS_INTERFACE(CEventTestRegister, IMoaRegister) 
