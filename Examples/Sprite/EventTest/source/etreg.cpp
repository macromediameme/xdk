...
/* ---------------------------------------------------- MoaCreate_CRegister */
STDMETHODIMP MoaCreate_CEventTestRegister(CEventTestRegister FAR * This)
{
	UNUSED(This);
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CEventTestRegister(CEventTestRegister FAR * This)
{
	UNUSED(This);
	X_ENTER
...
CEventTestRegister_IMoaRegister::CEventTestRegister_IMoaRegister(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
