...
STDMETHODIMP  		MoaCreate_CEventTestAsset(CEventTestAsset FAR * This)
{
	UNUSED(This);
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CEventTestAsset(CEventTestAsset FAR * This)
{
	UNUSED(This);
	X_ENTER
...
CEventTestAsset_IMoaMmXAsset::CEventTestAsset_IMoaMmXAsset(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
CEventTestAsset_IMoaMmXAsset::~CEventTestAsset_IMoaMmXAsset() {}

#ifdef USING_INIT_FROM_DICT
/* ------------------------------------ CEventTestAsset_IMoaInitFromDict Create/Destroy */
CEventTestAsset_IMoaInitFromDict::CEventTestAsset_IMoaInitFromDict(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
CEventTestAsset_IMoaNotificationClient::CEventTestAsset_IMoaNotificationClient(MoaError FAR * pErr)
	{ *pErr = (kMoaErr_NoErr); }
...
STDMETHODIMP CEventTestAsset_IMoaMmXAsset::GetInMemMediaSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CEventTestAsset_IMoaMmXAsset::GetStreamOutMediaSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CEventTestAsset_IMoaMmXAsset::GetInMemPropsSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CEventTestAsset_IMoaMmXAsset::GetStreamOutPropsSize(MoaUlong FAR * pSizeBytes)
{
	X_ENTER
...
STDMETHODIMP CEventTestAsset_IMoaMmXAsset::NewXActor(PMoaVoid FAR * ppXActor) 
{
	X_ENTER
