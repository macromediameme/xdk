 ...
 *	Name: xtra.cpp
 *	
 * 	Purpose: The Xtra definition of the Sprite Skeleton Xtra example.
 *
 *
 ...
 ****************************************************************************/ 
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CRegister, XTRA_VERSION_NUMBER) 
		CLASS_DEFINES_INTERFACE(CRegister, IMoaRegister, XTRA_VERSION_NUMBER)
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CAsset, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CAsset, IMoaMmXAsset, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CAsset, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CSprite, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CSprite, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CSprite, IMoaMmXSpriteActor, XTRA_VERSION_NUMBER)
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
