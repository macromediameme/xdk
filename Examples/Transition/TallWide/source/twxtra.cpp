 ...
 *	Name: TWXtra.cpp
 *	
 * 	Purpose: The Xtra definition of the TallWide Transition Xtra example.
 *
 ****************************************************************************/ 
 ...
 ****************************************************************************/ 
BEGIN_XTRA
	BEGIN_XTRA_DEFINES_CLASS(CTallWideRegister, XTRA_VERSION_NUMBER) 
		CLASS_DEFINES_INTERFACE(CTallWideRegister, IMoaRegister, XTRA_VERSION_NUMBER)
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CTallWideAsset, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CTallWideAsset, IMoaMmXAsset, XTRA_VERSION_NUMBER)
		#ifdef USING_INIT_FROM_DICT
		CLASS_DEFINES_INTERFACE(CTallWideAsset, IMoaInitFromDict, XTRA_VERSION_NUMBER)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CTallWideTransition, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CTallWideTransition, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CTallWideTransition, IMoaMmXTransitionActor, XTRA_VERSION_NUMBER)
	END_XTRA_DEFINES_CLASS
END_XTRA
