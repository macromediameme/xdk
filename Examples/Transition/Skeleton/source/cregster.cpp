...
#define kMyTransCaps		(kMoaMmTransCaps_ChangeArea)		
#define kMyDefaultTransArea	kMoaMmTransArea_ChangeArea			/* default transition area */
	...
	PIMoaDict pXtraDict)
{
	...
	PMoaChar 			symStr[kMyAssetTypeCount] 		= {"transStretch"};
	PMoaChar 			nameStr[kMyAssetTypeCount] 		= {"Stretch Transition"};
	...
	MoaMmTransCaps		transCaps[kMyAssetTypeCount]	= { kMyTransCaps };
	MoaLong				area[kMyAssetTypeCount]			= { kMyDefaultTransArea };
