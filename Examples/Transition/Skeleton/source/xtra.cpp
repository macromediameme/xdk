...
BEGIN_XTRA
	...
	BEGIN_XTRA_DEFINES_CLASS(CAsset, XTRA_VERSION_NUMBER)
		...
		CLASS_DEFINES_INTERFACE(CAsset, IMoaNotificationClient, XTRA_VERSION_NUMBER)	
		#endif
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CTransition, XTRA_VERSION_NUMBER)
		CLASS_DEFINES_INTERFACE(CTransition, IMoaMmXTransitionActor, XTRA_VERSION_NUMBER)
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
